            ...
            <div class="col-lg-6 py-6 px-5">
                ...
                <form action="formprocess.php" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="tel" name="phone" class="form-control" id="form-floating-3" placeholder="Subject">
                                <label for="form-floating-3">Subject</label>
                            </div>
                        </div>
                        <div>
                        <div  name="branch" style="display:flex;">
                            <label for="branch">Select Nearest Branch :</label>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Message" name="message" id="form-floating-4" style="height: 150px"></textarea>
